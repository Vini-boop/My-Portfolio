  ...
  const projects: Project[] = [
    {
      ...
      description: "A Tech-Hub that is focusing on transforming your career with cutting-edge technology education. From web development to Mobile App development, cybersecurity to R Language - master the skills that matter in today's digital world.",
      technologies: ['Python', 'React', 'Flask', 'SQLite'],
      category: 'Software Management System',
      icon: Shield,
    ...
    },
    {
      ...
      description: 'A mobile app that generates fantasy teams based on leagues (EPL, La Liga, Serie A, Bundesliga, Ligue 1). The team is generated by AI, integrated with team statistics to choose the best team of the week/day.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <div
              key={index}
              className={`bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group ${isVisible ? 'animate-slide-up' : 'opacity-0'
                }`}
